...
query_df = pd.DataFrame([{"qid": "test-environment-aeghhgwpe-pro02a", "query": query}])
...
print(pt.get_dataset('irds:beir/arguana').get_topics())

print(pt.Experiment(
        [bm25],
        pt.get_dataset('irds:beir/arguana').get_topics(),
        pt.get_dataset('irds:beir/arguana').get_qrels(),
