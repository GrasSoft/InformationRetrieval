...
index_pipeline = model >> NumpyIndex('indices/trec_covid_tct_colbert_v2_hnp_msmarco.np')

index_pipeline.index(dataset.get_corpus_iter())


index_path = Path("/home/obez/InformationRetrieval/indices/trec_covid_bm25_index")
